defmodule HelloWeb.PostControllerTest do
  ...
  @create_attrs %{context: "some context", title: "some title"}
  @update_attrs %{context: "some updated context", title: "some updated title"}
  @invalid_attrs %{context: nil, title: nil}
